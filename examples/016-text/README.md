...
Text is a bit trickier, and requires conversion from SVG web fonts.
An experimental [font2irmf](https://github.com/gmlewis/go-fonts) converter
is in the works, and is starting to show some promise.

![text-1.png](text-1.png)

* Try loading [text-1-gzip+base64.irmf](https://gmlewis.github.io/irmf-editor/?s=github.com/gmlewis/irmf-examples/blob/master/examples/016-text/text-1-gzip+base64.irmf) now in the experimental IRMF editor!
* Try loading [text-1-gzip.irmf](https://gmlewis.github.io/irmf-editor/?s=github.com/gmlewis/irmf-examples/blob/master/examples/016-text/text-1-gzip.irmf) now in the experimental IRMF editor!
...
* Try loading [text-1.irmf](https://gmlewis.github.io/irmf-editor/?s=github.com/gmlewis/irmf-examples/blob/master/examples/016-text/text-1.irmf) now in the experimental IRMF editor!
